 ...
 */
final class Version20240401201745 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE compte (id INT AUTO_INCREMENT NOT NULL, photo_id_id INT DEFAULT NULL, etablissement_id_id INT DEFAULT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, biographie VARCHAR(255) DEFAULT NULL, dernier_goldden_like DATETIME DEFAULT NULL, email VARCHAR(255) NOT NULL, nom_affichage VARCHAR(30) DEFAULT NULL, suspendu TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_CFF65260F85E0677 (username), INDEX IDX_CFF65260C51599E0 (photo_id_id), INDEX IDX_CFF65260FC5092A6 (etablissement_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE format (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(10) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE photo (id INT AUTO_INCREMENT NOT NULL, format_id_id INT NOT NULL, donnees_photo LONGBLOB NOT NULL, INDEX IDX_14B7841860DED95A (format_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
